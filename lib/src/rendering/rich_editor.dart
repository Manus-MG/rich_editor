          ...
          child: InAppWebView(
            ...
            onWebViewCreated: (controller) async {
              ...
              if (!kIsWeb && !Platform.isAndroid) {
                ...
                final assetUrl = Uri.tryParse('file:///android_asset/flutter_assets/$assetPath');

                if (assetUrl != null) {
                  // Convert to WebUri if necessary
                  final webUri = WebUri(assetUrl.toString()); // Adjust this as needed
            ...
            onConsoleMessage: (controller, consoleMessage) async {
              print('WebView Message: $consoleMessage');
            },
          ),
        ),
        Visibility(
